! function (t) {
    ...
    AFRAME.registerShader("gif", {
        ...
        init: function (t) {
            return h("init", t), h(this.el.components), this.__cnv = document.createElement("canvas"), this.__cnv.width = 2, this.__cnv.height = 2, this.__ctx = this.__cnv.getContext("2d"), this.__texture = new THREE.Texture(this.__cnv), this.__material = {}, this.__reset(), this.material = new THREE.MeshBasicMaterial({
                map: this.__texture
        ...
        __validateSrc: function (t, e) {
            ...
            if (o && "object" === ("undefined" == typeof o ? "undefined" : a(o))) {
                ...
                s && ! function () {
                    var i = u[t],
                        a = r(s, t);
                    i && i.callbacks ? i.callbacks.forEach(function (t) {
                        return t(a)
                    }) : e(a), u[t] = a
                }()
            }
            ...
            if (t !== this.__textureSrc) {
                ...
                o.crossOrigin = "Anonymous", o.addEventListener("load", function (e) {
                    a.__getUnit8Array(t, function (e) {
                        return e ? void(0, s.parseGIF)(e, function (e, i, r) {
                            var a = {
                                status: "success",
                                src: t,
                                times: e,
        ...
        __getUnit8Array: function (t, e) {
            if ("function" == typeof e) {
                ...
                i.open("GET", t), i.responseType = "arraybuffer", i.addEventListener("load", function (t) {
